...
void __fastcall TForm1::Otwrz1Click(TObject *Sender)
{
        ...
        if(OpenDialog1->Execute())
        {
                ...
                {
                ShowMessage(" Nie uda³o siê otworzy pliku ! Sprawdz czy plik istnieje ! ");
                }
        }
}
//---------------------------------------------------------------------------
void __fastcall TForm1::Zapiszjako1Click(TObject *Sender)
{
        if(SaveDialog1->Execute())
        {
                ...
                {
                ShowMessage("Zapis zakonczy³ siê niepowodzeniem !");
                }
        }
...
{
        if(Application->MessageBox("Czy napewno utworzyæ plik ?","PotwierdŸ",
...
{
        if(Application->MessageBox("Czy napewno zakoñczyc program ? ", "Potwierdz !",
